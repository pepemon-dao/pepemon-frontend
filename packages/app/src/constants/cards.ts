...
const ALL_SERIES = new Map([
	[1, process.env.NODE_ENV === 'development' ? [EVENT_ITEM_CARDS] : [EVENT_ITEM_CARDS, NEW_BEGINNING_PIXEL_CARDS, NEW_BEGINNING_CARDS, DUNGEONS_AND_DRAGONS, FRIENDS_SERIES_CARDS, CHARACTER_SERIES_CARDS, ORIGIN_SERIES]],
	[4, process.env.NODE_ENV === 'development' ? [EVENT_ITEM_CARDS, NEW_BEGINNING_CARDS, DUNGEONS_AND_DRAGONS] : [EVENT_ITEM_CARDS, NEW_BEGINNING_CARDS, DUNGEONS_AND_DRAGONS, FRIENDS_SERIES_CARDS, CHARACTER_SERIES_CARDS, ORIGIN_SERIES]],
