	...
	return (
		<ContentCentered style={{paddingTop: "7.5em", paddingBottom: "7.5em"}}>
			...
			<ContentBoxGrid gridTemplate='"socialBox1 socialBox2 socialBox3 socialBox4"'>
				<ContentBox as="a" href="https://twitter.com/pepemonfinance" target="_blank" rel="noopener noreferrer"
				bgColor={theme.color.purple[300]} style={{ gridArea: "socialBox1", boxShadow: "0 18.7px 14.2px 0 rgba(0, 0, 0, 0.1)" }}>
				...
				<ContentBox as="a" href="https://t.me/pepemonfinance" target="_blank" rel="noopener noreferrer"
				bgColor={theme.color.purple[300]} style={{ gridArea: "socialBox2", boxShadow: "0 18.7px 14.2px 0 rgba(0, 0, 0, 0.1)" }}>
				...
				<ContentBox as="a" href="https://discord.com/invite/R8sZwMv" target="_blank" rel="noopener noreferrer"
				bgColor={theme.color.purple[300]} style={{ gridArea: "socialBox3", boxShadow: "0 18.7px 14.2px 0 rgba(0, 0, 0, 0.1)" }}>
				...
				<ContentBox as="a" href="https://pepemonfinance.medium.com/" target="_blank" rel="noopener noreferrer"
				bgColor={theme.color.purple[300]} style={{ gridArea: "socialBox4", boxShadow: "0 18.7px 14.2px 0 rgba(0, 0, 0, 0.1)" }}>
