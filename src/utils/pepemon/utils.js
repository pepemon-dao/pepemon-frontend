...
export const merkleIsClaimed = async (merkleContract, index) => {
  try {
...
export const claimMerkle = async (merkleContract, index, account, amount, proof) => {
  try {
    return merkleContract.methods
