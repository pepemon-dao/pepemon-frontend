      ...
      <div className="container-wrap">
          ...
          <div className="main-container">
            <div className="text-container">
              ...
              <div className="actdiv">
                ...
                <div className="box-cont" style={{ marginTop: "150px" }}>
                  <div className="box-cont-bl">
                ...
                <div className="box-cont" style={{ marginTop: "300px" }}>
                  <div className="box-cont-bl">
        ...
        >
          ...
          <div className="cards-text-container">
            ...
            <span className="underlined-text" style={{width: "130px",marginTop:"80px"}}>
              Pepemon NFT
              <div
            ...
            <img src={claimyourcardbutton} style={{ width: "30%" ,marginTop:"30px"}} />
          </div>
        </div>
        ...
        >
          ...
          <span className="To-the-moon" style={{ marginTop: "30px" }}>
            To the moon
            <div className="underline-div" style={{width:"138px",backgroundColor:"#fff",margin:"0"}}></div>
          </span>
                ...
                <Value
                  value={
                    poolStatistics.ppblzPool && poolStatistics.uniV2Pool
                      ? poolStatistics.uniV2Pool.tvl +
                        poolStatistics.ppblzPool.tvl
                      : "Loading..."
                  }
                />
              </span>
          ...
          <div className="fudizard-container">
            <div style={{ width: "60%", padding: "200px" , paddingRight: "0px"}}>
            ...
            <div style={{ width: "56%", paddingRight: "0px" }}>
        ...
        <div className="middle-container">
          ...
          <div className="text-logo-contain">
            <div style={{ width: "50%", paddingLeft: "120px" }}>
              <div style={{ width: "61%", marginLeft: "200px" }}>
                ...
                <div
                  className="underline-div"
                  style={{ width: "155px", marginLeft: "0" }}
                ></div>
                ...
                <span className="Duel-other-trainers">
                  ...
                  <span className="text-style-1"> here </span>and let's discuss
                  on the different strategies for the closed Beta launch
                  happening soon for card holders.
                </span>
              </div>
            </div>
