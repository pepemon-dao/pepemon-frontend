								...
								<div>
									<div style={{display: 'flex'}}>
										<StyledStoreWrapper width="100%">
											<StyledStoreHeader>
												<div style={{display: 'flex'}}>
													<StyledTitle as="h2" inactive={routerParams.storeState !== "cards"} color={theme.color.white} size="1.2rem" font={theme.font.neometric}>
														<Link to={`/store/cards`}>Cards</Link>
													</StyledTitle>
													<StyledTitle as="h2" inactive={routerParams.storeState !== "boosterpacks"} color={theme.color.white} size="1.2rem" font={theme.font.neometric}>
